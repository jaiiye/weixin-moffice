package com.jfinal.weixin.sdk.test;
...
public class WxCryptUtilTest {
  ...
  String token = "oxxI";
  String timestamp = "1415941981";
  String nonce = "1161724677";
  ...
  public void testAesDncrypt() {
    ...
    WxCryptUtil pc = new WxCryptUtil("oxxI", encodingAesKey, "wxb21adacab9c87404");
    ...
    String sb=null;
    //sb = pc.decrypt(msgSignature, "1415958709", "442448040", encryptedXml);
  ...
  public void testAesEncrypt() {
    WxCryptUtil pc = new WxCryptUtil(token, encodingAesKey, appId);
    //Assert.assertEquals(pc.encrypt(randomStr, replyMsg), afterAesEncrypt);
  }

 
  public void testAesEncrypt2() {
    WxCryptUtil pc = new WxCryptUtil(token, encodingAesKey, appId);
    //Assert.assertEquals(pc.encrypt(randomStr, replyMsg2), afterAesEncrypt2);
  }
